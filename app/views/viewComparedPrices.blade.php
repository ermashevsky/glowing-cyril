...
<div class="container-fluid" style="margin-top: 66px;">
    ...
    <div class="page-header">
        <h3><i class="glyphicon glyphicon-dashboard"></i> Сравнение тарифов - Сводная информация</h3>
    </div>
{{  HTML::link(URL::to('/compareTariffs'),' Назад', array('class' => 'btn btn-warning glyphicon glyphicon-arrow-left')) }}

    <?php $i = 1 ?>
<div id="comparePriceTable" style="margin-top:10px;">
