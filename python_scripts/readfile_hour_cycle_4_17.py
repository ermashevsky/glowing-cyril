...
server, username, password = ('91.196.4.17', 'den', '555den')
...
test3filehandle = open(
    "/home/agent/virtualenvs/loganalyzer/app/diff_file_4_17.txt", "w")
                       # creating a file handle to write
old_lines = file(local_path).read().split('\n')
new_lines = file(
    "/home/agent/virtualenvs/loganalyzer/app/logs/tmp4_17.log").read().split('\n')
...
out = commands.getoutput(
    "cat /home/agent/virtualenvs/loganalyzer/app/diff_file_4_17.txt | wc -l")

print 'Найдено ' + out + ' новых строк'

ins = open("/home/agent/virtualenvs/loganalyzer/app/diff_file_4_17.txt", "r")
...
shutil.move(local_path, '/home/agent/virtualenvs/loganalyzer/app/logs/tmp4_17.log')
os.remove('/home/agent/virtualenvs/loganalyzer/app/diff_file_4_17.txt')
