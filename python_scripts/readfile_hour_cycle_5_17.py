...
test3filehandle = open(
    "/home/agent/virtualenvs/loganalyzer/app/diff_file.txt", "w")
...
out = commands.getoutput(
    "cat /home/agent/virtualenvs/loganalyzer/app/diff_file.txt | wc -l")

print 'Найдено ' + out + ' новых строк'

ins = open("/home/agent/virtualenvs/loganalyzer/app/diff_file.txt", "r")
...
os.remove('/home/agent/virtualenvs/loganalyzer/app/diff_file.txt')
