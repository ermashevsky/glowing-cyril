...
local_path = "/tmp/full_tmp4_17.log"
sftp = ssh.open_sftp()
...
test3filehandle = open(
    "/home/agent/virtualenvs/loganalyzer/app/full_diff_file_4_17.txt", "w")
...
out = commands.getoutput(
    "cat /home/agent/virtualenvs/loganalyzer/app/full_diff_file_4_17.txt | wc -l")

print 'Найдено ' + out + ' новых строк'

ins = open("/home/agent/virtualenvs/loganalyzer/app/full_diff_file_4_17.txt", "r")
...
os.remove('/home/agent/virtualenvs/loganalyzer/app/full_diff_file_4_17.txt')
